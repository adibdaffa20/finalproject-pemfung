    ...
    <View style={{flex: 1, backgroundColor: colors.themeColor}}>
      ...
      <View style={{backgroundColor: colors.themeColor, flex: 1}}>
        ...
        <ScrollView style={{padding: 16, flex: 1}}>
          ...
          <Text style={{color: colors.black, fontSize: 30}}>{'Daffa'}</Text>
            ...
            <View style={styles.categoryContainer}>
              <TouchableOpacity onPress={() => handleCategoryPress('All')}>
                <View
                  style={[
                    styles.category,
                    allSelected && styles.selectedCategory,
                ...
                >
                  <Text
                    style={[
                      styles.categoryText,
                      allSelected && styles.selectedCategoryText,
                    ]}
                  >
                    All
                  </Text>
            ...
            <View style={styles.frameContainer}>
              <TouchableOpacity onPress={() => handleFramePress('UI/UX')}>
                <View style={styles.frame}>
                  <Image
                    source={{
                      uri: 'https://koma.or.id/wp-content/uploads/2024/02/Frame-4-1024x598.png',
                    }}
            ...
            <View style={styles.frameContainer}>
              <TouchableOpacity onPress={() => handleFramePress('Web Dev')}>
                <View style={styles.frame}>
                  <Image
                    source={{
                      uri: 'https://www.simplilearn.com/ice9/free_resources_article_thumb/is_web_development_good_career.jpg',
                    }}
                    style={styles.frameImage}
                  />
                  <View>
            ...
            <View style={styles.frameContainer}>
              <TouchableOpacity onPress={() => handleFramePress('Apple Dev')}>
                <View style={styles.frame}>
                  <Image
                    source={{
                      uri: 'https://developer.apple.com/news/images/og/apple-developer-og.png',
                    }}
                    style={styles.frameImage}
                  />
                  <View>
